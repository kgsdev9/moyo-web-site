    ...
    <div class="col-lg-8 col-xl-7 offset-xl-1">
      ...
      <form class="row g-4 needs-validation" novalidate>
        <div class="col-sm-12">
          ...
          <input class="form-control form-control-lg" type="text" placeholder="Votre nom complet" required id="nomComplet" />
        ...
        <div class="col-sm-6">
          ...
          <input class="form-control form-control-lg" type="tel" placeholder="Votre numéro de téléphone" required id="telephone" />
          <div class="invalid-feedback">Veuillez entrer un numéro de téléphone valide !</div>
        </div>

        <div class="col-sm-6">
          <label class="form-label fs-base" for="email">Email</label>
          <input class="form-control form-control-lg" type="email" placeholder="Votre adresse email" required id="email" />
          <div class="invalid-feedback">Veuillez entrer une adresse email valide !</div>
        </div>

        <div class="col-sm-12">
          <label class="form-label fs-base" for="pays">Pays</label>
          <input class="form-control form-control-lg" type="text" placeholder="Votre pays de résidence" required id="pays" />
