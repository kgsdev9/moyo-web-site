                ...
                <div class="row">
                    <div class="col-md-4 text-center text-md-start">
                        ...
                        <p class="pb-3 pb-sm-4">
                            ...
                            d'applications éducatives, ainsi que de solutions de paiement pour les frais de scolarité et les
                            fournitures.
                        </p>
                        ...
                        <div class="accordion" id="faq">
                            ...
                            <div class="accordion-item bg-light">
                                ...
                                <div class="accordion-collapse collapse show" id="questionOne" aria-labelledby="headingOne"
                                    ...
                                    <div class="accordion-body fs-sm">
                                        Moyo est une fintech éducative qui aide les parents à gérer facilement les paiements
                                        et
                                        l’épargne pour la scolarité de leurs enfants. Elle permet aussi aux professionnels
                                        de
                                        l’éducation d’accéder à des services dédiés. Moyo rend l’éducation plus accessible
                                        et
                            ...
                            <div class="accordion-item bg-light">
                                ...
                                <div class="accordion-collapse collapse" id="questionTwo" aria-labelledby="headingTwo"
                                    data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">
                                        Le rechargement consiste à choisir un mode de paiement (Wave, Orange Money, Moov
                                        Money,
                            ...
                            <div class="accordion-item bg-light">
                                ...
                                <div class="accordion-collapse collapse" id="questionThree" aria-labelledby="headingThree"
                                    data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">
                                        Le parent utilise son compte principal pour payer la scolarité via l’onglet «
                                        Scolarité
                                        ». Il doit s’assurer que son solde est suffisant, c’est-à-dire supérieur au montant
                                        à
                            ...
                            <div class="accordion-item bg-light">
                                ...
                                <div class="accordion-collapse collapse" id="questionFour" aria-labelledby="headingFour"
                                    data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">
                                        Grâce à Moyo, vous pouvez payer les frais scolaires en plusieurs fois de manière
                                        simple
                                        et sécurisée
                            ...
                            <div class="accordion-item bg-light">
                                ...
                                <div class="accordion-collapse collapse" id="questionFive" aria-labelledby="headingFive"
                                    data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">
                                        Moyo prend en charge toutes les démarches liées à la scolarité de l’enfant :
                                        paiement
                                        des frais, suivi des échéances et communication avec l’école. En jouant ce rôle à la
                                        place du parent, Moyo facilite la gestion complète de la scolarité et simplifie la
                                        vie
                                        des familles.
                                    </div>
                                </div>
                            ...
                            <div class="accordion-item bg-light">
                                ...
                                <div class="accordion-collapse collapse" id="questionSix" aria-labelledby="headingSix"
                                    data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">
                                        Le coffre scolaire permet aux parents d’épargner facilement et en toute sécurité
                                        pour
                                        les frais de scolarité de leurs enfants. Il garantit que l’argent est réservé
                                        uniquement
                            ...
                            <div class="accordion-item bg-light">
                                ...
                                <div class="accordion-collapse collapse" id="questionSeven"
                                    ...
                                    <div class="accordion-body fs-sm">
                                        ...
                                        proches, amis et ONG, de contribuer facilement ensemble au financement de la
                                        scolarité
                            ...
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingNine">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#questionNine" aria-expanded="false"
                                        aria-controls="questionNine">
                                ...
                                <div class="accordion-collapse collapse" id="questionNine" aria-labelledby="headingNine"
                                    data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">
                                        Pour avoir accès aux services Moyo, chaque parent doit s’acquitter d’une somme de 2
                                        000
                                        FCFA pour l’activation du compte. Cette activation inclut la délivrance de la carte
                                        digitale scolaire Moyo. L’application est disponible sur le Play Store et l’App
                                        Store.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item bg-light">
                                ...
                                <div class="accordion-collapse collapse" id="questionTen" aria-labelledby="headingTen"
                                    data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">
                                        Pour annuler le service Moyo, vous pouvez contacter le service client via
                                        l’application
                                        ou par email. Après confirmation, votre compte sera désactivé et vos fonds restants
                                        vous
